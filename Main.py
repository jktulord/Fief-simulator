...
word = ""
state = "MENU"
namelist = ["John","Max","Макс","Макс_Хас","Акакаий","Добрыня","Яков","Нурберг","Паша","Пася","Саша","Сася","Johnathan","Johnson","Joe","Jerry","Jackson","Jefferson","Jacob","Jack","Jokey"]
plebs = []
...
while exit == 0:
    ...
    if state == "MENU": # стейт меню
        ...
        i = 0
        for p in plebs:
            print("№",i,"Имя:", p.name+" "*(9-len(p.name)),"Работа:", p.job,"Деньги:", p.money,"Дом:",p.house,"Коровы:",p.cow,
                  "|Гр:",p.mushrooms,"|Пш:",p.wheet,"|Млк:",p.milk,"|Др:",p.wood,"|")
            i=i+1
        print("---")
        ...
        print("Рассчитываемый доход за",pl.day-1," |Гр:",pl.incomingMushrooms,"|Пш:",pl.incomingWheet,"|Млк:",pl.incomingMilk,"|Др:",pl.incomingWood,"|")
